...
exports.seed = async function(knex) {
  ...
  await knex('events').insert([
    ...
    {id:2, event_name:'水族館', event_name_kana:'すいぞくかん', genre:'スポット', address:'東京都品川区勝島3-2-1', tel:'0337623433', email:'', prefecture:'東京都', city:'品川区', date:'2021,05,01', start_time:'12:00', end_time:'20:00', description:'魚！', owner_id:'hide_owner'},
